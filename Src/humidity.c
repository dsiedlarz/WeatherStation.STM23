...
/** @addtogroup HTS221_Callable_Private_FunctionPrototypes
 * @{
 */
 ...
 HUM_TEMP_StatusTypeDef HTS221_Calibration(void)
{
    ...
    if(HTS221_IO_Read(tempReg, HTS221_ADDRESS, HTS221_T0_OUT_L_ADDR + 0x80, 2) != HUM_TEMP_OK)
    {
      return HUM_TEMP_ERROR;
    }
    ...
    if(HTS221_IO_Read(tempReg, HTS221_ADDRESS, HTS221_T1_OUT_L_ADDR + 0x80, 2) != HUM_TEMP_OK)
    {
      return HUM_TEMP_ERROR;
    }
    ...
    if(HTS221_IO_Read(&tempReg[0], HTS221_ADDRESS, HTS221_H0_T0_OUT_L_ADDR + 0x80, 2) != HUM_TEMP_OK)
    {
      return HUM_TEMP_ERROR;
    }
    ...
    if(HTS221_IO_Read(&tempReg[0], HTS221_ADDRESS, HTS221_H1_T0_OUT_L_ADDR  + 0x80, 2) != HUM_TEMP_OK)
    {
      return HUM_TEMP_ERROR;
    }
 ...
 HUM_TEMP_StatusTypeDef HTS221_GetHumidity(float* pfData)
{
    ...
    if(HTS221_IO_Read(&tempReg[0], HTS221_ADDRESS, HTS221_HUMIDITY_OUT_L_ADDR + 0x80, 2) != HUM_TEMP_OK)
    {
      return HUM_TEMP_ERROR;
    }
 ...
 HUM_TEMP_StatusTypeDef HTS221_GetTemperature(float* pfData)
{
    ...
    if(HTS221_IO_Read(&tempReg[0], HTS221_ADDRESS, HTS221_TEMP_OUT_L_ADDR + 0x80, 2) != HUM_TEMP_OK)
    {
      return HUM_TEMP_ERROR;
    }
