...
/** @addtogroup HUM_TEMP_Exported_Variables Exported variables
 * @{
 */
...
/**
  * @}
  */
extern HUM_TEMP_StatusTypeDef      HTS221_Init(HUM_TEMP_InitTypeDef *HTS221_Init);
extern HUM_TEMP_StatusTypeDef      HTS221_Power_OFF(void);
extern HUM_TEMP_StatusTypeDef      HTS221_ReadID(uint8_t *ht_id);
extern HUM_TEMP_StatusTypeDef      HTS221_RebootCmd(void);
extern HUM_TEMP_StatusTypeDef      HTS221_GetHumidity(float* pfData);
extern HUM_TEMP_StatusTypeDef      HTS221_GetTemperature(float* pfData);
extern HUM_TEMP_StatusTypeDef HTS221_Power_On(void);
extern HUM_TEMP_StatusTypeDef HTS221_Calibration(void);
